...
namespace webapi.event_manha.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdTipoEevento = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IdInstituicao = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Evento_TiposEvento_IdTipoEevento",
                        column: x => x.IdTipoEevento,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Evento_IdTipoEevento",
                table: "Evento",
                column: "IdTipoEevento");
